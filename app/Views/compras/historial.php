<section class="container py-4">
    ...
    <?php if (!$ventas): ?>
        <div class="empty-state">
            ...
            <a href="<?= url('productos/index') ?>" class="btn btn-primary">Comprar ahora</a>
        </div>
    <?php else: ?>
                    ...
                    <tbody>
                        <?php foreach ($ventas as $venta): ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="<?= url('ventas/detalle') ?>&id=<?= $venta['id_venta'] ?>" class="btn btn-sm btn-outline-primary">Ver detalle</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
